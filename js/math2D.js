...
function vector(vec_params, mode) {
  ...
  vec_params.reflect = function(v) { // reflect about this axis
    var dtheta = v.th - this.th;
    this._set_rth(this.r, mod360_symmetric(v.th + dtheta));
  }
  vec_params._transform = function(args) { this.transform.apply(this, arguments); }
  vec_params.transform = function(args) { // affine transform
